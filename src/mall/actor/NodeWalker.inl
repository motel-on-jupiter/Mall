...
inline int NodeGraphWalker::BuildTravelListImpl(const Waypoint *point, const Waypoint *finalgoal, std::vector<const Waypoint *> &breadcrumbs, std::vector<const Waypoint *> **minlist) {
